...
function ProjectDetail() {
  ...
  const loadCharacters = useCallback(async () => {
    try {
      ...
      setCharactersError(
        err.message || "Failed to load characters for this project.",
      );
    } finally {
  ...
  return (
    <div className="page-shell project-detail">
      ...
      <section className="character-section" aria-labelledby="characters-heading">
        <div className="character-section__header">
        ...
        {charactersLoading && <Loader text="Loading characters..." />}
        ...
        {!charactersLoading && !charactersError && characters.length === 0 && (
          <EmptyState
            ...
            description="Create your first character to start building this story's cast."
            action={
              <Link
                to={`/projects/${projectId}/characters/new`}
                className="button button--primary"
        ...
        {!charactersLoading && !charactersError && characters.length > 0 && (
          <div className="character-section__grid">
